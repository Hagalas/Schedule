...
from downloader.tasks import run_processors
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        file_obj = File.objects.get_or_create(
            ...
            file_url='http://wimii.pcz.pl/download/plan_stacjonarny/plan1.html',
            category=FileCategory.objects.get_or_create(
                name='groups',
                code_name='groups_from_wimii',
            )[0],
        )[0]
        file_obj.save()
        self.stdout.write('Successfully added file "%s"' % file_obj.file_name)
